...
mockgen -source supervisor/iptablesutils/iptablesutils.go -destination supervisor/iptablesutils/mock/mock_iptablesutils.go -package mockiptablesutils
...
mockgen -source supervisor/provider/iptablesprovider.go -destination supervisor/provider/mock/mock_iptablesprovider.go -package mockprovider
